...
public abstract class Repo<TEntity extends Entity> implements IRepo<TEntity>, IUnitOfWorkRepository{
	...
	protected Repo(Connection connection, IEntityBuilder<TEntity> builder, IUnitOfWork uow) {
